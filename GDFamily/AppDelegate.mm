...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    GDFSlideController<GDFSlideControllerChild,GDFSlideControllerStatus> *leftCenter = [[GDFSlideController alloc]initWithLeftViewController:vc centerViewController:left];
